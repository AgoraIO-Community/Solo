...
)
{
    ...
    sateCtl->stHBEnc = malloc(sizeof(AGR_Sate_encoder_hb_state_FLP));

	memset(sateCtl->stHBEnc, 0, sizeof(AGR_Sate_encoder_hb_state_FLP));
...
)
{
    ...
    SKP_int32  ret;
			...
			sateCtl->stHBDec = malloc( sizeof(AGR_Sate_decoder_hb_state_FLP ));

			memset(sateCtl->stHBDec, 0, sizeof(AGR_Sate_decoder_hb_state_FLP));
